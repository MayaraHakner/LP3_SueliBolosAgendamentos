...
public class StatusGUI_JTable extends JDialog {
    ...
    public StatusGUI_JTable() {
        ...
        tableModel = new StatusTableModel(daoStatus.listInOrderId());
...
//        painelBotoes.add(btnRem);
       ...
       // tipoColumn.setCellEditor(new DefaultCellEditor(comboBox));
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               int a = daoStatus.autoIdStatus();
                status.setIdStatus(a);           
              //tableModel.addTableModelListener(table);
                status.setNomeStatus("  ");
                try {
                    Status c = daoStatus.obter(a);
                    if (c == null) {
                        ...
                        JOptionPane.showMessageDialog(cp, "Já existe essa status");
                    }
                } catch (Exception err) {
                    JOptionPane.showMessageDialog(cp, "Erro ao inserir a status =>" + status.getIdStatus() + " com o erro=>" + err.getMessage());
                }
    ...
    public static void main(String[] args) {
        //new UnMedidaGUI(new Point(880, 250), new Dimension(800, 600));
